...
Neovim is available per tab through the `herdr-nvim` sidebar (`prefix+e`)
instead of a dedicated tab; see [herdr-nvim sidebar and file picker](#herdr-nvim-sidebar-and-file-picker).
